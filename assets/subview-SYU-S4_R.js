import{O as s,S as m,C as g}from"./utilities-xCp6wZLy.js";let t;await s.onReady(async()=>{t=(await s.theme.getTheme()).mode,m(t,document),s.theme.onChange(i=>{t=i.mode,m(t,document)});const e=(await s.scene.getMetadata())[`${g.EXTENSIONID}/dialogueBox`];let l=await s.viewport.getWidth()<500;e.Type==="notice"&&(l=!0);const v=`
