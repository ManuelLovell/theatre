import{O as s,C as n}from"./bsConstants-DqcM23cc.js";import{S as h}from"./bsSceneCache-Cw6B9coG.js";await s.onReady(async()=>{const m=await s.theme.getTheme();h(m,document);const e=(await s.player.getMetadata())[`${n.EXTENSIONID}/dialogueBox`];let r=await s.viewport.getWidth()<600;e.Type==="notice"&&(r=!0);const g=`
